namespace GymPassBokning.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        GymClass_GymClassId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.ApplicationUser_Id, t.GymClass_GymClassId })
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id, cascadeDelete: true)
                .ForeignKey("dbo.GymClasses", t => t.GymClass_GymClassId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationUserGymClasses", "GymClass_GymClassId", "dbo.GymClasses");
            DropForeignKey("dbo.ApplicationUserGymClasses", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropIndex("dbo.ApplicationUserGymClasses", new[] { "GymClass_GymClassId" });
